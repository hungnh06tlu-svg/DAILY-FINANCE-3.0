...
| **D3-002** | Root | DOMAIN | Invariant Test Runner & Property Tests | `IN PROGRESS` | `50%` | AI Studio | D3-001 | 2026-08-28 | — | `EVD-D3-002A` | D3-003 |
...
| └── **D3-002B** | D3-002 | DOMAIN | Property-Based Invariant Regression Tests | `NOT STARTED` | `0%` | Unassigned | D3-002A | — | — | None | D3-003 |
